...
class Edrone():
	...
	self.roll_pub = rospy.Publisher,('/roll_error', edrone_cmd,queue_size=1)
	self.pitch_pub = rospy.Publisher('/pitch_error', edrone_cmd ,queue_size=1)
	self.yaw_pub = rospy.Publisher('/yaw_error', edrone_cmd,queue_size=1)
        # -----------------------------------------------------------------------------------------------------------
